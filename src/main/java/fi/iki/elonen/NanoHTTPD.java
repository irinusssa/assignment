...
public abstract class NanoHTTPD {
    ...
    public static class Response {
		...
		public boolean isKeepAlive() {
			if (requestHeader != null
					&& requestHeader.get("connection") != null
					&& requestHeader.get("connection").toLowerCase()
							.contains("keep-alive")) {
				return true;
			}
			return false;
    ...
    protected class HTTPSession implements Runnable {
        ...
        public boolean isConnectionKeepAlive() {
			if (header != null && header.get("connection") != null
					&& header.get("connection").toLowerCase().contains("keep-alive")) {
				return true;
			}
        	return false;
        }
        ...
        public boolean isConnectionClose() {
			if (header != null && header.get("connection") != null
					&& header.get("connection").toLowerCase().contains("close")) {
				return true;
			}
        	return false;
        }
